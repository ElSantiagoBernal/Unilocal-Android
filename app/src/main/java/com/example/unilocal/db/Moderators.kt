...
object Moderators {
    ...
    init {
        moderators.add(Moderator(1,"Andres","Ocampo","andres@gmail.com","Z4ND3R","helado444",1,1,1,21))
        moderators.add(Moderator(2,"Santiago","Bernal","santiago@gmail.com","ElSantiago","1234",1,1,1,20))
    }
