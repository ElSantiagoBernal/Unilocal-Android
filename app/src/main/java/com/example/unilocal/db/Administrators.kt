...
object Administrators {
    ...
    init {
        administrators.add(Administrator(1, "Admin1","Admin1", "admin1@gmail.com","helado444",1,1,1,21))
        administrators.add(Administrator(2, "Admin2","Admin2", "admin2@gmail.com","1234",1,1,1,20))
    }
