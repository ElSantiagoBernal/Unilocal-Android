...
object Places {
    ...
    init {
        ...
        val place1 = Place(1, "Maria Licky", "Comidas Rápidas", 1, PlaceStatus.ACCEPTED, 3, "Cll 12B 15-02",45.545454f,-23.87867f,1,1,1)
        place1.schedules.add(schedule1)
        val place2 = Place(2, "Hotel San José", "El hotel más exclusivo del santander", 2, PlaceStatus.ACCEPTED, 1, "En el santander xd",45.545454f,-23.87867f,1,1,1)
        place2.schedules.add(schedule2)
        val place3 = Place(3, "Unicentro", "Centro Comercial unicentro", 3, PlaceStatus.REJECTED, 4, "San Agustín 22-30",45.545454f,-23.87867f,1,1,1)
        ...
        val place6 = Place(6, "Licky Liquors", "Licorera", 3, PlaceStatus.ACCEPTED, 5, "Av. Centenario B13-9",45.545454f,-23.87867f,1,1,1)
